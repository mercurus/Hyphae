            ...
            <a href="#">
                <div class="media search-result">
                    <div class="media-left search-icon-block">
                        <BIcon icon="sun" extraClasses="is-size-2 m-3" />
                        <span class="is-block is-size-7 has-text-weight-bold">asdf</span>
                    </div>
                    <div class="media-content">
                        <div class="is-flex">
                            <span class="has-text-weight-bold is-flex-grow-1">qwerty</span>
                            <div class="has-text-dark pr-1 is-size-6">
                                <!-- <span class="m-0">#{{ obj.id }}</span> -->
                                <BIcon icon="puzzle-piece" />
                            </div>
                        </div>
